...
export default function HomePage() {
  ...
  return (
    <Container>
      ...
      {/* PHOTO GALLERY: compact personal and athletics glimpse */}
      <section className="mt-14 mb-10">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-wider text-zinc-400">Beyond the projects</p>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight">Engineering and athletics</h2>
          </div>
          <Link href="/track" className="text-sm font-medium text-blue-400 transition-colors hover:text-blue-300">
            Explore Track & Field →
          </Link>
        </div>
